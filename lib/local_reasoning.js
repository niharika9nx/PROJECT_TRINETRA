...
async function reasonLocally({ at, userGoal, screenshot, threshold = DEFAULT_THRESHOLD, llm = null, vlm = null } = {}) {
  ...
  // Any query: use threshold as-is (0.7 default). Low confidence (compare/summarize/ambiguous 0.45) → cloud, high (0.85 laptop) → local with real AT IDs (Flipkart + Amazon)
